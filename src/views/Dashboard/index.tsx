...
function Dashboard() {
    ...
    const trimmedStakingAPY = trim(app.stakingAPY * 100, 2);
            ...
            <div className="dashboard-infos-wrap">
                <Zoom in={true}>
                    <Grid container spacing={4}>
                        ...
                        <Grid item lg={6} md={6} sm={6} xs={12}>
                            <div className="dashboard-card">
                                <p className="card-title">FNY Price</p>
                        ...
                        <Grid item lg={6} md={6} sm={6} xs={12}>
                            <div className="dashboard-card">
                                ...
                                <p className="card-value">{isAppLoading ? <Skeleton width="250px" /> : `${trimmedStakingAPY}%`}</p>
                            </div>
                        </Grid>
                        ...
                        <Grid item lg={6} md={6} sm={6} xs={12}>
                            <div className="dashboard-card">
                                ...
                                <p className="card-value">{isAppLoading ? <Skeleton width="250px" /> : `${trim(Number(app.currentIndex), 2)} FNY`}</p>
                            </div>
                        </Grid>
                        ...
                        <Grid item lg={6} md={6} sm={6} xs={12}>
                            <div className="dashboard-card">
                                <p className="card-title">Backing per $FNY *</p>
                                <p className="card-value">
                                    {isAppLoading ? (
                                        <Skeleton width="250px" />
                                    ) : (
