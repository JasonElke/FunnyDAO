...
import { musdc } from "../../../helpers/tokens";
...
function Zapin({ open, handleClose, bond }: IZapinProps) {
    ...
    let defaultToken = tokens.find(token => token.name);
    ...
    const setMax = () => {
        ...
        let amount: any = Math.min(maxBondPriceToken, token.isMetis ? token.balance * 0.99 : token.balance);
                    ...
                    <div className="zapin-header">
                        ...
                        {!hasAllowance() && !token.isMetis && (
                            <div className="zapin-header-help-text">
                                <p>Note: The "Approve" transaction is only needed when bonding for the first fny</p>
                    ...
                    <div className="zapin-body">
                        ...
                        <div className="zapin-body-params">
                            ...
                            <div className="data-row">
                                ...
                                <p className="data-row-value">{isLoading ? <Skeleton width="100px" /> : `~ ${trim(bond.bondQuote, 4)} FNY`}</p>
                            </div>
                            <div className="data-row">
                                <p className="data-row-name">Max You Can Buy</p>
                                <p className="data-row-value">{isLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4)} FNY`}</p>
                            </div>
                            <div className="data-row">
                            ...
                            <div className="data-row">
                                ...
                                <p className="data-row-value">0.01 FNY</p>
                            </div>
