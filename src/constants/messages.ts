export const messages = {
    please_connect: "Please connect your wallet to the Matic network to use The Funny.",
    please_connect_wallet: "Please connect your wallet.",
    try_mint_more: (value: string) => `You're trying to mint more than the maximum payout available! The maximum mint payout is ${value} FNY.`,
    ...
    switch_to_metis: "Switch to the BSC Network?",
