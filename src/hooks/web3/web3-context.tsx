...
export const Web3ContextProvider: React.FC<{ children: ReactElement }> = ({ children }) => {
        ...
        new Web3Modal({
            ...
            providerOptions: {
                walletconnect: {
                    ...
                    options: {
                        rpc: {
                            [Networks.ARBITRUM_GOERLI]: getMainnetURI(),
                        },
                        qrcode: true,
    ...
    const connect = useCallback(async () => {
        ...
        if (chainId !== Networks.ARBITRUM_GOERLI) {
    ...
    const checkWrongNetwork = async (): Promise<boolean> => {
        ...
        // if (!currentNetworkNumber) {
        //     return false
        // }

        if (chainId !== DEFAULD_NETWORK) {
            const shouldSwitch = window.confirm(messages.switch_to_metis);
            if (shouldSwitch) {
